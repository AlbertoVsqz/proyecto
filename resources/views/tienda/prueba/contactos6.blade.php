            ...
            <table style="text-align:left" width="650" cellspacing="0" cellpadding="10" border="0" bgcolor="#ffffff"> 
                ...
                <tr> 
                    <td valign="top">
                        ...
                        A continuación encontrarás los datos para realizar el retiro de los productos de su pedido. Nuevamente te agradecemos por tu compra.
                        </p><br>
                        <p style="color:#58585a;font-size:14px;line-height:16px;margin:0px 0 16px 0"> 
                        Tu pedido # <strong>{!!$idpedido!!}</strong> <br><br>
                        Instalaciones: <strong>La Empresa San Miguel Centro<br>

                            503 26615233<br>

                            San Miguel-Col. 15 De Septiembre, San Miguel<br>

                            soporte_sv@empresa.com<br>

                            www.empresa.com </strong><br>
                     

                        <br><br>
                        Tu # de pedido;  <strong>{!!$idpedido!!}</strong> (indica a la hora de retirar el producto) 
